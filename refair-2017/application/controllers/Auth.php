...
class Auth extends CI_Controller {
	...
	public function __construct()
	{
        ...
        $live = $this->session->userdata('live') || 0;
	...
	// log the user in
	public function login($referrer='')
	{
        ...
        $this->menus = array("Auth/register~Register",
                             "#about~About");
        ...
        //VALIDATE THE PASSWORD FOR NO TILDE!
		...
		if ($this->form_validation->run() == true)
		{
			...
			if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember))
			{
				...
				//redirect them back to the home page or the referrer
				$this->session->set_flashdata('message', $this->ion_auth->messages());
                $pasdat[]=array('message'=>$this->ion_auth->messages());
                $CI = & get_instance();
                $CI->active = true;
                $this->_rd_referrer_redirect($referrer);
            }
            else
            {
                ...
                $pasdat[]=array('message'=>$this->ion_auth->errors());
        ...
        $pasdat[]=array('message'=>"Hello, let us log you in");
        ...
        $this->parts[CONTENTE] = $this->load->view('auth/login',$this->pasdat,true);
    }
    ...
    public function register()
    {
        ...
        $this->parts[META] = $this->load->view('metas',$this->pasdat,true);
        $this->parts[COOKIE] = $this->load->view('cookie',$this->pasdat,true);
        $this->parts[CONTENTE] = $this->load->view('auth/register',$this->pasdat,true);
    }
    ...
    public function logout()
    {
        ...
        // redirect them to the login page
        $this->session->set_flashdata('message', $this->ion_auth->messages());
        $this->session->set_flashdata('error', "Logged off");
    ...
    public function forgot_password()
    {
        ...
        else
        {
            ...
            if(empty($identity)) {
                ...
                $this->session->set_flashdata('message', $this->ion_auth->errors());
                $this->message=array('message'=>$this->ion_auth->errors());
                echo "here we are";
            ...
            if ($forgotten)
            {
                ...
                $this->message=array('message', $this->ion_auth->messages());
                redirect("auth/login", 'refresh'); //we should display a confirmation page here instead of the login page
            }
            else
            {
                echo "It's fucked here";
                $this->message=array('message',$this->ion_auth->errors());
                redirect("auth/forgot_password", 'refresh');
            }
            $this->pasdat[]=$this->message;
        }
        ...
        $this->parts[SCRIPTS] = $this->load->view('scripts-refair',$this->pasdat,true);
        $this->parts[META] = $this->load->view('metas',$this->pasdat,true);
        $this->parts[CONTENTE] = $this->load->view('auth/forgot_password',$this->pasdat,true);
    }
    ...
    public function reset_password($code = NULL)
    {
        ...
        $user = $this->ion_auth->forgotten_password_check($code); //this is so elegant.
        //such a beautiful piece of code. This is a masterpiece.
        //These lines made me believe in humanity
        ...
        if ($user)
        {
            ...
            if ($this->form_validation->run() == false)
            {
                echo "Form Validation run in reset_password";
                ...
                $this->parts[COOKIE] = $this->load->view('cookie',$this->pasdat,true);
                $this->parts[META] = $this->load->view('metas',$this->pasdat,true);
                $this->parts[CONTENTE] = $this->load->view('auth/reset_password',$this->data,true);
            }
            else
            {
                ...
                // }else
                {
                    ...
                    if ($change)
                    {
                        echo "Password change in reset_password";
    ...
    public function setCookie(){
        $cook = array('name'=>'Refair of Slavingway.com',value=>'Irish Coffee');
