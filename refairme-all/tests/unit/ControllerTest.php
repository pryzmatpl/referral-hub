...
final class ControllerTest extends \PHPUnit\Framework\TestCase
{
  ...
  public function testIwahashLonger()
  {
    ...
    $nucon = new \App\Controllers\Controller($container);
    $this->assertEquals($nucon->iwahash($dat,'NAME:PIOTR~SURNAME:SLUPSKI~BIRTH:19.04.1989~EMAIL:piotroxp@gmail.com'),
			'cHJpem1+TkFNRTpQSU9UUn5TVVJOQU1FOlNMVVBTS0l+QklSVEg6MTkuMDQuMTk4OX5FTUFJTDpwaW90cm94cEBnbWFpbC5jb20=');
  }
