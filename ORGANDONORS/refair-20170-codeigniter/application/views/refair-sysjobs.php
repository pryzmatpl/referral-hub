...
<div class="content-main" style="width:100% !important;"><h2>Our latest jobs</h2></div><br/>
  <?php
    $jobs = $this->dataJobs;
    if(count($jobs)>0){
  foreach ($jobs as $value){
  ?>
    <div class="silver" style="height:670px; width:350px;float:left;margin:15px;display:block;padding:15px;">
