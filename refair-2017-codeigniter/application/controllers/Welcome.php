...
class Welcome extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->parts[CONTENTE] = $this->load->view('content',$this->pasdat,true);
        $this->parts[SUBMIT] = $this->load->view('submit',$this->pasdat,true);
        $this->parts[WAITING] = $this->load->view('waiting',$this->pasdat,true);
        ...
        $this->parts[FAME] = $this->load->view('fame',$this->pasdat,true);
    }
    ...
    public function secure($hhash)
    {
        ...
        $this->styles = array("style");
        $this->menus = array("Welcome/logoff~Log out now",
                             "Account/secure/".$hhash."~Manage Account",
                             "Welcome/tutorial~Log off and see tutorial");
        $this->pasdat = array($this->menus);
        ...
        $this->parts[SUBMIT] = $this->load->view('submit',$this->pasdat,true);
        $this->parts[WAITING] = $this->load->view('waiting',$this->pasdat,true);
        //TODO:The below need more data is PASDAT or have to change ever so slightly
        $this->parts[POPULAR] = $this->load->view('popular',$this->pasdat,true);
        $this->parts[NOTIFICATIONS] = $this->load->view('notifications',$this->pasdat,true);
        $this->parts[FAME] = $this->load->view('fame',$this->pasdat,true);
