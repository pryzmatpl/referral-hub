<template>
  <div class="card mt-2">
    <div class="card-body">
      ...
      <p>We collect and process some or all of the following types of information from you:</p>
      <ul>
        <li>Information that you provide by filling in forms on the TechSorted/ RefairMe’s.com website (“Website”)or App. This includes information provided at the time of registering to use the Website, subscribing to our Services, posting material or requesting further information or services. We may also ask you for information when you report a problem with the Website.</li>
        ...
        <li>Details of all actions that you carry out through the Website ,App and of the provision of services to you.</li>
        <li>Details of your visits to the Website and App including, but not limited to, traffic data, location data, weblogs and other communication data, the site that referred you to our site and the resources that you access.</li>
      </ul>
      <p>
      ...
      <p>From time to time we also obtain personal data from other sources as follows:</p>
      <ul>
      ...
      <h1>Uses made of your information</h1>
      <p>
      ...
      <ul>
        ...
        <li>To provide you with information, products or services that you request from us or which we feel may interest you or our Customer.</li>
        <li>To carry out our obligations arising from any contracts entered into between our Customer (on whose behalf you are using the Services) and Us.</li>
        <li>To notify you about changes to our Services and provide you with information that is relevant to your use of the Services.</li>
        <li>Where you or your employer are a prospective Customer, to provide you with information about our Services for marketing purposes.</li>
      </ul>
      ...
      <ul>
        ...
        <li>if we are under a duty to disclose or share your personal data in order to comply with any legal obligation or in order to enforce or apply our Website Terms and Conditions and other agreements, but we will endeavour to minimise such disclosure to only that reasonably necessary and, where possible, to provide you with notice of such disclosure; and/or</li>
        <li>to protect the rights, property, or safety of TechSorted/ RefairMe’s Technology Limited, the Website, our users and any third party we interact with to provide the Website.</li>
      </ul>
      <h1>How we store your personal data</h1>
      <h3>Security</h3>
      <p>
      ...
      <p>Your personal information will be deleted on one of the following occurrences:</p>
      <ul>
        <li>deletion of your personal information by you (or by another person engaged by the Customer); or</li>
        <li>receipt of a written request by you (or another person engaged by the Customer) to us.</li>
      </ul>
      <h1>Your rights</h1>
      <p>
        Under the 
        <a href="https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32016R0679&from=EN">General Data Protection Regulation</a>
      ...
      <h1>IP Addresses and cookies</h1>
      <p>
      ...
      <p>
        ...
        <a href="mailto:support@RefairMe.com">support@RefairMe.com</a>
      </p>
    </div>
  </div>
</template>
...
export default {
  data () {
    return {
      items: [
        { name_of_sub_processor: 'Amazon Web Services, Inc.', address_of_sub_processor: '410 Terry Ave North Seattle, WA 98109-5210'},
        { name_of_sub_processor: 'Google Cloud Platform', address_of_sub_processor: 'Google Ireland Limited,\nGordon House, Barrow Street, Dublin 4, Ireland'},
      ]
    }
  }
}
